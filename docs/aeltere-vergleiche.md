...
| V7 → V8         | Klarheit: Flächen und Teile | Als `clockwork-v8-vergleich.zip` am [Release v1.2.0](https://github.com/keco216/clockwork/releases/tag/v1.2.0) |
| v1.3.0 → v1.4.0 | Mobil: erst ablesen         | [`v10-vergleich/`](v10-vergleich/README.md) — im Repo                                                          |
