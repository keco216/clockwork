...
export default {
  ...
  'vault.explain':
    'По умолчанию Clockwork не сохраняет ничего. При желании введённое можно оставить здесь ' +
    'зашифрованным парольной фразой: PBKDF2-SHA-256 с {iterations} итерациями, затем ' +
    'AES-256-GCM. Без парольной фразы сохранённый блок ничего не стоит.',
  ...
  'vacant.text':
    'Пока ничего не введено. Вставьте выше secret — или возьмите через {demo} тестовый ключ ' +
    'из RFC 4226.',
  ...
  'demo.comment': '# Тестовый ключ из RFC 4226 — secret это текст «12345678901234567890»',
  'demo.label': 'Тест RFC',
