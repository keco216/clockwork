...
export default {
  ...
  'vacant.text':
    'Todavía no hay nada. Pon un secret arriba — o toma la clave de prueba de la RFC 4226 ' +
    'con {demo}.',
  ...
  'demo.comment':
    '# Clave de prueba de la RFC 4226 — el secret es el texto « 12345678901234567890 »',
  'demo.label': 'Prueba RFC',
