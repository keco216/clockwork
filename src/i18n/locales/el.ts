...
export default {
  ...
  'vault.explain':
    'Από προεπιλογή το Clockwork δεν αποθηκεύει τίποτα. Αν ενεργοποιήσετε το ' +
    'χρηματοκιβώτιο, η καταχώριση μένει εδώ κρυπτογραφημένη με τη συνθηματική φράση σας — ' +
    'χωρίς αυτή το αποθηκευμένο μπλοκ δεν αξίζει τίποτα.',
  'vault.explain.crypto':
    'Το κλειδί παράγεται από τη συνθηματική φράση με PBKDF2-SHA-256 και {iterations} ' +
    'επαναλήψεις, ενώ το AES-256-GCM κάνει την κρυπτογράφηση. Αποθηκεύεται μόνο ο ' +
    'σφραγισμένος φάκελος: ποτέ το απλό κείμενο, ποτέ η συνθηματική φράση, ποτέ το ' +
    'παραγόμενο κλειδί.',
  'vault.explain.more': 'Όλες οι λεπτομέρειες',
