...
export default {
  ...
  'vacant.text':
    'Ingenting lagt inn ennå. Sett inn en secret ovenfor — eller ta testnøkkelen fra RFC 4226 ' +
    'med {demo}.',
  ...
  'demo.comment': '# Testnøkkel fra RFC 4226 — din secret er teksten «12345678901234567890»',
  'demo.label': 'RFC-test',
