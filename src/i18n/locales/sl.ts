...
export default {
  ...
  'input.help.more': 'Vse vhodne oblike',
  ...
  'filter.placeholder': 'Filtriraj po imenu',
  'filter.empty': 'Nič se ne ujema z »{query}«.',
  ...
  'vacant.text':
    'Skrivnost, povezava otpauth ali slika QR — nič od tega ne zapusti tega brskalnika.',
