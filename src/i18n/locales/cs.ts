...
export default {
  ...
  'vacant.text':
    'Zatím nic zadáno. Vložte nahoře secret — nebo si vezměte přes {demo} testovací klíč ' +
    'z RFC 4226.',
  ...
  'demo.comment': '# Testovací klíč z RFC 4226 — secret je text „12345678901234567890“',
  'demo.label': 'Test RFC',
