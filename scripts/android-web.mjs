 ...
 * capacitor.config.ts). Clockwork nimmt dafür die Einzeldatei
 * `dist/clockwork.html` — warum nicht der PWA-Build, steht am Kopf von
 * capacitor.config.ts.
 *
...
console.log(
  `✓ dist-android/index.html — die Einzeldatei als App-Inhalt, ` +
