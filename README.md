...
| ---------------------- | --------------------- | ------ |
| default (37 languages) | 599 kB                | 216 kB |
| `de,en,fr`             | 310 kB                | 145 kB |
| `en` only              | 294 kB                | 140 kB |
...
| `dist/clockwork.html` | One file, everything inline — including the fonts. ~599 kB      |
...
The fonts under `src/assets/fonts/` are Instrument Sans and Chivo Mono, both
under the SIL Open Font License; their licence texts sit next to them.
